...
rm trace1.txt
rm trace2.txt
rm trace1_vdr_5_3wrk_featured_soc.txt
...
mv trace1.txt trace1_vdr_5_3wrk_featured_soc.txt

kill $(jobs -p)
wait

rm trace1_phcap_4_3wrk_featured_soc.txt
...
rm watch_out_test_file
mv trace1.txt trace1_phcap_4_3wrk_featured_soc.txt


kill $(jobs -p)
wait

rm trace1_gl1_3_3wrk_featured_soc.txt
...
rm watch_out_test_file
mv trace1.txt trace1_gl1_3_3wrk_featured_soc.txt

kill $(jobs -p)
wait

rm trace1_adply_1_3wrk_featured_soc.txt
...
rm watch_out_test_file
mv trace1.txt trace1_adply_1_3wrk_featured_soc.txt

kill $(jobs -p)
wait

rm trace1_adr_1_3wrk_featured_soc.txt
...
rm watch_out_test_file
mv trace1.txt trace1_adr_1_3wrk_featured_soc.txt

kill $(jobs -p)
wait

rm trace1_skype_1_3wrk_featured_soc.txt
...
rm watch_out_test_file
mv trace1.txt trace1_skype_1_3wrk_featured_soc.txt
