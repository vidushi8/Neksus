 ...
 *
 * Auto generated C++ code started by /data1/home/vidushi/GemDroid_booksim_pack_grnl_sip/gem5/src/mem/slicc/symbols/StateMachine.py:426
...
L1Cache_Controller::a_issueRequest(L1Cache_TBE*& m_tbe_ptr, L1Cache_Entry*& m_cache_entry_ptr, const Address& addr)
{
    ...
    ((*m_L1Cache_requestFromCache_ptr)).enqueue(out_msg, Cycles(m_issue_latency));
}
    ...
    assert(in_msg_ptr != NULL); // Check the cast result
{
    ...
    ((*m_L1Cache_responseFromCache_ptr)).enqueue(out_msg, Cycles(m_cache_response_latency));
}
}
...
L1Cache_Controller::n_popResponseQueue(L1Cache_TBE*& m_tbe_ptr, L1Cache_Entry*& m_cache_entry_ptr, const Address& addr)
{
    ...
    (profileMsgDelay((1), (((*m_L1Cache_responseToCache_ptr)).dequeue())));
...
L1Cache_Controller::o_popForwardedRequestQueue(L1Cache_TBE*& m_tbe_ptr, L1Cache_Entry*& m_cache_entry_ptr, const Address& addr)
{
    ...
    (profileMsgDelay((2), (((*m_L1Cache_forwardToCache_ptr)).dequeue())));
